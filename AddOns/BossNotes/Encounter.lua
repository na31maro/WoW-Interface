...
BOSS_NOTES_ENCOUNTERS = {
	{
		-- BFA Raids - Added by Horrorbrood
	...
	
	{
		...
		instances = {
			...
			},
			{
				...
				105629, 110966, 98759, 17252, 62982, 98733, 103130, 
				105921, 105876, 98728, 105952, 98426, 100393, 105651, 
				98732, 106546, 102351, 98756, 103109, 105915, 105617, 
				105682, 98770, 106059, 106757, 98776, 102849, 98425, 
				113699, 11859},
				encounters = {
					{
						-- "Ivanyr"
			...
			},
			{
				...
				instanceId = "SOT",
				npcIds = {122313, 122316, 124309, 122314},
				encounters = {
					{
						-- "Zural the Ascended"
						encounterId = 122313,
	...
	},
	{
		...
		instances = {
			...
			{		
				...
				instanceId = "LABT",
				npcIds = {123371, 126916, 122367, 122104, 125562, 125055, 125050, 125075, 122468, 124691, 124828},
				encounters = {
					{
					...
					},
					{
						...
						encounterId = 126916,
						npcIds = {126916, 126915}
					},
					{
						-- "Antoran High Command"
						encounterId = 122367,
						npcIds = {122367, 125012, 125014}
					},
					{
