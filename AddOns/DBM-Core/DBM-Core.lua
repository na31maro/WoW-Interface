...
DBM = {
	Revision = parseCurseDate("20191107012918"),
	DisplayVersion = "8.2.26", -- the string that is shown as version
	ReleaseRevision = releaseDate(2019, 11, 6) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
