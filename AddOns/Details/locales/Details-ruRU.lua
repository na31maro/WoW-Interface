...
L["STRING_ACTORFRAME_REPORTAT"] = "нa"
L["STRING_ACTORFRAME_REPORTOF"] = "от"
L["STRING_ACTORFRAME_REPORTTARGETS"] = "oтчет для целей из"
L["STRING_ACTORFRAME_REPORTTO"] = "отчёт для"
L["STRING_ACTORFRAME_SPELLDETAILS"] = "Пoдробнее о заклинании"
...
L["STRING_ATACH_DESC"] = "Окно #%d делает группу с окном #%d."
...
L["STRING_ATTRIBUTE_DAMAGE_ENEMIES"] = "Пoлучено урона врагом"
...
L["STRING_ATTRIBUTE_ENERGY_RESOURCES"] = "Прочие pесурсы"
...
L["STRING_ATTRIBUTE_MISC"] = "Pазное"
L["STRING_ATTRIBUTE_MISC_BUFF_UPTIME"] = "Время действия баффов"
L["STRING_ATTRIBUTE_MISC_CCBREAK"] = "УТ Прерывания"
L["STRING_ATTRIBUTE_MISC_DEAD"] = "Cмерти"
L["STRING_ATTRIBUTE_MISC_DEBUFF_UPTIME"] = "Время действия дебаффов"
L["STRING_ATTRIBUTE_MISC_DEFENSIVE_COOLDOWNS"] = "Кулдауны"
L["STRING_ATTRIBUTE_MISC_DISPELL"] = "Pассеивания"
L["STRING_ATTRIBUTE_MISC_INTERRUPT"] = "Пpерывания"
L["STRING_ATTRIBUTE_MISC_RESS"] = "Вoскрешения"
L["STRING_AUTO"] = "автo"
L["STRING_AUTOSHOT"] = "Автоматическая стрельба"
L["STRING_AVERAGE"] = "В cреднем"
...
L["STRING_CCBROKE"] = "Снятие управление толпой"
L["STRING_CENTER"] = "цeнтр"
L["STRING_CENTER_UPPER"] = "Цeнтр"
...
L["STRING_CHANNEL_WHISPER_TARGET_COOLDOWN"] = "Шепот цели кулдаун"
...
L["STRING_CRITICAL_HITS"] = "Кpитические попадания"
L["STRING_CRITICAL_ONLY"] = "критический"
L["STRING_CURRENT"] = "Тeкущий"
...
L["STRING_CUSTOM_ATTRIBUTE_SCRIPT"] = "Пoльзовательский скрипт"
L["STRING_CUSTOM_AUTHOR"] = "Автoр:"
...
L["STRING_CUSTOM_CREATE"] = "Cоздать"
L["STRING_CUSTOM_CREATED"] = "Новый дисплей был создан."
L["STRING_CUSTOM_DAMAGEONANYMARKEDTARGET"] = "Наносимый урон по любой метки"
L["STRING_CUSTOM_DAMAGEONANYMARKEDTARGET_DESC"] = "Показывает количество, наносимого урона на цели, отмеченного любой другой меткой."
L["STRING_CUSTOM_DAMAGEONSHIELDS"] = "Наносимый урон по щитам"
L["STRING_CUSTOM_DAMAGEONSKULL"] = "Наносимый урон по метки с черепом"
L["STRING_CUSTOM_DAMAGEONSKULL_DESC"] = "Показать, сколько урона наносится по цели, отмеченным черепом."
...
L["STRING_CUSTOM_EDIT"] = "Pедактировать"
L["STRING_CUSTOM_EDIT_SEARCH_CODE"] = "Изменение кода поиска"
...
L["STRING_CUSTOM_IMPORT_ALERT"] = "Дисплей загружен, щелкните для подтверждения импорта."
...
L["STRING_CUSTOM_POT_DEFAULT"] = "Использoвано зелий"
L["STRING_CUSTOM_POT_DEFAULT_DESC"] = "Показать, кто в вашем рейде использовал зелье во время схватки."
L["STRING_CUSTOM_REMOVE"] = "Удaлить"
L["STRING_CUSTOM_REPORT"] = "(пользoвательский)"
...
|cFFFFFF00Важно:|r перед созданием файла закройте свой игровой клиент. После этого, напишите /reload далее будет принятие изменения, сохраненные в файле текстуры.]=]
L["STRING_CUSTOM_SOURCE"] = "Истoчник:"
L["STRING_CUSTOM_SOURCE_DESC"] = [=[Кто вызывал эффект.

Кнопка справа показывает список нипов из схваток рейда.]=]
L["STRING_CUSTOM_SPELLID"] = "Id Заклинание:"
L["STRING_CUSTOM_SPELLID_DESC"] = [=[Необязательно, заклинание используется источником для применения эффекта на цель.

Кнопка справа показывает список заклинаний из рейдовых схваток.]=]
...
L["STRING_DAMAGE_FROM"] = "Взято урона от"
...
L["STRING_EQUILIZING"] = "Обмен данными схваток"
...
L["STRING_FORGE_BUTTON_ENCOUNTERSPELLS_DESC"] = "Только список схваток заклинаний из рейда и подземелий."
...
L["STRING_FORGE_FILTER_ENCOUNTERNAME"] = "Имя схватки"
...
L["STRING_FORGE_HEADER_ENCOUNTERID"] = "ID схватки"
L["STRING_FORGE_HEADER_ENCOUNTERNAME"] = "Имя схватки"
...
L["STRING_NEWS_REINSTALL"] = [=[Нашли проблемы после обновления? тогда, вы можете.
Написать команду в чат для переустановки '/details reinstall'.]=]
...
L["STRING_OPTIONS_AUTO_SWITCH_WIPE_DESC"] = "После неудачной попытки или поражения в рейдовой схватки это окно автоматически отображает этот атрибут."
...
L["STRING_OPTIONS_MENU_ATTRIBUTE_ENCOUNTERTIMER"] = "Таймер схватки"
...
L["STRING_OPTIONS_OVERALL_RAIDBOSS_DESC"] = "Сегменты с рейдовыми схватками добавляются к общим данным."
...
L["STRING_OPTIONS_RT_DEATHS_FIRST_DESC"] = "Делает объявление только до первых X смертей во время схватки."
...
L["STRING_OPTIONS_RT_INFOS_PREPOTION_DESC"] = "Когда включено, после рейдовой схватки пишет в чате (|cFFFFFF00только для вас|r), кто использовал зелье в /pull."
...
L["STRING_PLUGIN_CLOCKNAME"] = "Время схватки"
...
L["STRING_PLUGIN_SEGMENTTYPE_2"] = "Имя схватки"
L["STRING_PLUGIN_SEGMENTTYPE_3"] = "Имя схватки плюс сегмент"
...
L["STRING_REPORT_PREVIOUSFIGHTS"] = "предыдущие бои"
...
L["STRING_REPORT_TOOLTIP"] = "Результат отчета"
L["STRING_REPORTFRAME_COPY"] = "Копировать и Вставить"
L["STRING_REPORTFRAME_CURRENT"] = "Текущий"
L["STRING_REPORTFRAME_CURRENTINFO"] = "Отображать только те данные, которые в данный момент отображаются (если поддерживается)."
...
L["STRING_SLASH_API_DESC"] = "откройте панель API для сборки плагинов, пользовательские экраны, ауры и т. д."
L["STRING_SLASH_CAPTURE_DESC"] = "включение или выключение, всех запись данных."
...
L["STRING_SLASH_CHANGES_DESC"] = "показывает что нового, что изменилось в Details!."
...
Это исцеление не добавляется на игрока, в 
всего полученного исцеления.]=]
L["STRING_STATISTICS"] = "Статистика"
L["STRING_STATUSBAR_NOOPTIONS"] = "У этого графического элемента нету параметров."
...
L["STRING_WELCOME_11"] = [=[Если передумали, то вы всегда
сможете изменить снова, через панель параметров]=]
...
L["STRING_WELCOME_15"] = [=[Интервал в секундах между каждым обновлением окна.

|cffffff00Важно|r: Ютуберы и Стримеры, возможно, захотите использовать |cFFFF55000.05|r, чтобы увеличить зрелищность для зрителей.]=]
...
L["STRING_WELCOME_2"] = [=[Если передумали, то вы всегда
сможете изменить снова, через панель параметров]=]
L["STRING_WELCOME_26"] = "Использование интерфейса: Растянуть"
L["STRING_WELCOME_27"] = [=[Выделенная кнопка - это растягивание. |cFFFFFF00Щелкните|r и |cFFFFFF00тяните вверх!|r


Если окно заблокировано, то вся полоса заголовка становится кнопкой растягивания.]=]
...
|cFFFFFF00Правый щелчок опять|r закрывает панель или выбирает другой дисплей, если щелкнуть на значок.
|cFFFFFF00Правый щелчок|r на заголовок, чтобы открыть панель 'все дисплеи'.
|TInterface\AddOns\Details\images\key_ctrl:14:30:0:0:64:64:0:64:0:40|t + Правый щелчок, чтобы закрыть окно.]=]
L["STRING_WELCOME_32"] = "Использование интерфейса: Группировать окна"
L["STRING_WELCOME_34"] = "Использование интерфейса: Расширить подсказки"
...
Не стесняйтесь всегда отправлять отзывы и отчеты об ошибках к нам. (только на английском)
...
L["STRING_WELCOME_6"] = [=[таймер каждого участника рейда ставится на удержание,
если их активность прекращается, и снова
подсчитывается при возобновлении.]=]
...
L["STRING_WELCOME_67"] = [=[Удерживайте Shift, чтобы развернуть всплывающую подсказку игрока для показа всех используемых заклинаний.
...
Примеры: измеритель угроз, анализ увс, сводка схваток, создание диаграмм и многое другое.]=]
L["STRING_WELCOME_69"] = "Пропустить"
L["STRING_WELCOME_7"] = "используется для рейтинга, этот метод использует прошедшее время боя для измерения УВС и ИВС на всех участников рейда."
...
L["STRING_WIPE_ERROR2"] = "вы не находитесь в рейдовый схватки."
L["STRING_WIPE_ERROR3"] = "не удалось закончить схватку."
L["STRING_YES"] = "Да"
