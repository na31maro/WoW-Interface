...
--> global name declaration
		...
		_detalhes.build_counter = 7150
		_detalhes.alpha_build_counter = 7150 --if this is higher than the regular counter, use it instead
...
--[[
|cFFFFFF00v8.2.0.7149.140 (|cFFFFCC00July 2nd, 2019|r|cFFFFFF00)|r:\n\n
